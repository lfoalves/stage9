      ...
      <main>
        ...
        <section>
            <Title>
              <h1>Interestellar</h1>
              <div>
              { data.rating  && data.rating == 1 ? <Star /> : '' }
              { data.rating  && data.rating == 2 ? <><Star /><Star /></> : '' }
              { data.rating  && data.rating == 3 ? <><Star /><Star /><Star /></> : '' }
              { data.rating  && data.rating == 4 ? <><Star /><Star /><Star /><Star /></> : '' }
